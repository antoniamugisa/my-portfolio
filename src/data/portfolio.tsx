...
export const experiences = [
  {
    ...
    location: "Toronto, ON",
    description: "Engineered document processing solutions using RAG and vector embeddings, optimized client workflows, and resolved critical system issues to improve operational efficiency.",
    achievements: [
      "Engineered document parsing pipeline using RAG and vector embeddings, reducing manual data ingestion time by 25%.",
      "Resolved client access failures by refactoring backend authorization, eliminating all 403 errors and preventing 15 daily database exceptions.",
      "Drove 15% increase in client conversion by deploying dynamic tooltips and visual status indicators.",
      "Optimized document-submission flow, reducing sorting time by 40% and saving 3–5 hours per week."
    ],
